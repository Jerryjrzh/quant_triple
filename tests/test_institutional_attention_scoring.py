...
from stock_analysis_system.analysis.institutional_attention_scoring import (
    InstitutionalAttentionScoringSystem, AttentionScoreCalculator, AttentionScore,
    StockAttentionProfile, AttentionLevel, BehaviorPattern, ActivityIntensity
)
...
class TestAttentionScoreCalculator:
    ...
    def sample_activities(self, sample_institution):
        ...
        for i in range(10):
            activity = InstitutionalActivity(
                ...
                activity_type=ActivityType.DRAGON_TIGER_BUY if i % 2 == 0 else ActivityType.DRAGON_TIGER_SELL,
                amount=1000000 * (i + 1),
                volume=100000 * (i + 1),
    ...
    def test_calculate_attention_score_basic(self, calculator, sample_institution, sample_activities):
    ...
    def test_calculate_attention_score_empty_activities(self, calculator, sample_institution):
    ...
    def test_calculate_recency_score(self, calculator, sample_institution):
        ...
        recent_score = calculator._calculate_recency_score(recent_activities, reference_date)
    ...
    def test_calculate_frequency_score(self, calculator, sample_institution):
        ...
        regular_score = calculator._calculate_frequency_score(regular_activities, reference_date)
        irregular_score = calculator._calculate_frequency_score(irregular_activities, reference_date)
    ...
    def test_calculate_activity_regularity(self, calculator, sample_institution):
        ...
        irregular_score = calculator._calculate_activity_regularity(irregular_activities)
...
class TestInstitutionalAttentionScoringSystem:
    ...
    def mock_graph_analytics(self):
        ...
        analytics.build_institutional_network = AsyncMock(side_effect=mock_build_network)
        ...
        analytics.get_institution_relationships = Mock(side_effect=mock_get_relationships)
...
class TestDataStructures:
    ...
    def test_behavior_pattern_enum(self):
        ...
        expected_patterns = [
            "accumulating", "distributing", "momentum_following", "contrarian",
            "swing_trading", "long_term_holding", "coordinated", "opportunistic"
        ]

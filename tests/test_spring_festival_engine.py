...
class TestChineseCalendar:
    ...
    def test_is_spring_festival_period(self):
        ...
        is_in_period, sf_date = ChineseCalendar.is_spring_festival_period(
            test_date, window_days=15
        )
...
class TestSpringFestivalAlignmentEngine:
    ...
    def test_align_insufficient_years(self, engine, sample_stock_data):
        ...
        single_year_data = sample_stock_data[
            sample_stock_data["trade_date"].dt.year == 2024
        ]
    ...
    def test_generate_trading_signals(self, engine):
        ...
        assert (
            "buy" in signals["recommended_action"]
            or "watch" in signals["recommended_action"]
        )

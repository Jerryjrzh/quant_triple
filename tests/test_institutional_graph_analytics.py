...
from stock_analysis_system.analysis.institutional_graph_analytics import (
    InstitutionalGraphAnalytics, InstitutionalRelationship, CoordinatedActivityPattern,
    NetworkMetrics, RelationshipType
)
...
class TestInstitutionalGraphAnalytics:
    ...
    def test_create_time_windows(self, graph_analytics):
        ...
        # Create time windows
        windows = graph_analytics._create_time_windows(
            activities, timedelta(days=3)
        )
    ...
    def test_calculate_network_metrics(self, graph_analytics):
        ...
        for centrality_dict in [metrics.degree_centrality, 
...
class TestRelationshipDetection:
    ...
    def test_temporal_correlation_detection(self):
        ...
        for i in range(10):
            ...
            activities1.append(InstitutionalActivity(
            ...
            activities2.append(InstitutionalActivity(
    ...
    def test_activity_correlation_calculation(self):
        ...
        correlation = analytics._calculate_activity_correlation(activities1, activities2)
        ...
        correlation = analytics._calculate_activity_correlation(single_activity, activities2)

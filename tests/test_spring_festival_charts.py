...
class TestSpringFestivalChartEngine:
    ...
    def test_create_overlay_chart_with_selected_years(
        self, chart_engine, sample_aligned_data
    ):
        """Test creating overlay chart with selected years."""
        selected_years = [2020, 2022]
        fig = chart_engine.create_overlay_chart(
            sample_aligned_data, selected_years=selected_years
        )
    ...
    def test_create_cluster_visualization(
        self, mock_pca, mock_scaler, mock_kmeans, chart_engine, sample_aligned_data
    ):
        ...
        with patch.object(
            chart_engine.sf_engine, "identify_seasonal_patterns"
        ) as mock_identify:
            mock_pattern = Mock()
    ...
    def test_create_overlay_chart_with_pattern_info(
        self, mock_add_annotations, chart_engine, sample_aligned_data
    ):
        ...
        with patch.object(
            ...
            fig = chart_engine.create_overlay_chart(
                sample_aligned_data, show_pattern_info=True
            )

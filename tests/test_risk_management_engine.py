...
class TestEnhancedRiskManagementEngine:
    ...
    @pytest.mark.asyncio
    async def test_comprehensive_risk_metrics_calculation(
        self, risk_engine, sample_price_data
    ):
        """Test comprehensive risk metrics calculation."""

        result = await risk_engine.calculate_comprehensive_risk_metrics(
            sample_price_data
        )
    ...
    @pytest.mark.asyncio
    async def test_historical_volatility_calculation(
        self, risk_engine, sample_price_data
    ):
    ...
    async def test_beta_calculation(
        self, risk_engine, sample_price_data, sample_benchmark_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_liquidity_risk_score_calculation(
        self, risk_engine, sample_price_data, sample_volume_data
    ):
        """Test liquidity risk score calculation."""

        score = await risk_engine._calculate_liquidity_risk_score(
...
class TestPortfolioRiskFunctions:
    ...
    def test_portfolio_var_calculation(self):
        ...
        correlations = np.array([[1.0, 0.5, 0.3], [0.5, 1.0, 0.4], [0.3, 0.4, 1.0]])
...
class TestStressTesting:
    ...
    async def test_stress_test_portfolio(self):
        ...
        risk_engine.calculate_comprehensive_risk_metrics.return_value = (
            mock_risk_metrics
        )
        ...
        # Run stress test
        results = await stress_test_portfolio(
